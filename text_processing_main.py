...
def main():
    ...
    with open(sys.argv[1], 'r+') as c_file:
        ...
        receiver = Receiver(in_pipe, msg_queues, t_processor, end_msg_validator)
        sender_1 = Sender(out_pipe_a1, msg_queue_1, end_msg_validator)
        sender_2 = Sender(out_pipe_a2, msg_queue_2, end_msg_validator)
